                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="courseTitle" class="form-label">
                                    ...
                                    <i class="bi bi-question-circle" data-bs-toggle="tooltip"
                                        title="Maximum of 100 characters allowed."></i>
                                </label>
                                <div class="row">
                                    <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                <label for="courseCategory" class="form-label">
                                    ...
                                    <i class="bi bi-question-circle" data-bs-toggle="tooltip"
                                        title="What category best fits your program/course"></i>
                                </label>
                                <div class="row">
                                    <div class="col-md-6">
                                        {!!
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-header">
                                            <label class="form-label">
                                                ...
                                                <i class="bi bi-question-circle" data-bs-toggle="tooltip"
                                                    title="Upload image of less than 1MB"></i>
                                                <span class="help-text">Maximum file size allowed 1MB</span>
                                            </label>
                                        </div>
                                        <div class="card-body">
                                            <div class="my-dropzone mb-5">Dropzone</div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12 mt-3 media-container">
                                                    <img src="{{ asset($course->thumbnail) }}" width="150" />
                                                    <button type="button"
                                                        class="btn btn-sm delete-media-btn btn btn-outline-danger"
                                                        data-bs-toggle="tooltip" title="Delete image." data-post-url="{{ route('courses.delete-media', [
                                                                    'course' => $course->id,
                                    ...
                                    <div class="card mb-3" id="trailerVidCont">
                                        <div class="card-header">
                                            <label class="form-label">
                                                ...
                                                <i class="bi bi-question-circle" data-bs-toggle="tooltip"
                                                    title="Maximum size allowed 1GB"></i>
                                            </label>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-12 d-sm-flex mb-3">
                                                    <div class="form-check">
                                                        ...
                                                        "class" => "form-check-input trailer-video-type
                                                        show-hide-trigger",
                                                    ...
                                                    <div class="form-check ms-sm-3">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="trailerStorageTypeExternal">
                                                            Link to Vimeo/Youtube Video
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 initial-hide tlVidTypeInputBox"
                                                    id="tlVidTypeLocalInputBox">
                                                    <input type="file" name="trailer" class="form-control" />
                                                    @error('trailer')
                                                    <span class="form-text form-error">{{ $message }}</span>
                                                    @enderror
                                                    <div class="form-text fw-bold">Maximum file size allowed 1GB, For
                                                        larger files use Vimeo/Youtube.</div>
                                                </div>
                                                <div class="col-sm-12 initial-hide tlVidTypeInputBox"
                                                    id="tlVidTypeExtInputBox">
                                                    ...
                                                    <span class="form-text form-error">{{ $message }}</span>
                                                    @enderror
                                                    <div class="form-text fw-bold">Youtube/Vimeo link starting with
                                                        https://</div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 mt-3">
                                                        <video id="my-player" class="video-js" controls preload="auto"
                                                            width="350" @if ($course->trailer_cover)
                                                            poster="{{ asset($course->trailer_cover) }}"
                                                            @endif
                                                            data-setup='{}'
                                                            >
                                                            <source src="{{ asset($course->trailer) }}">
                                                            </source>
                                                            <p class="vjs-no-js">
                                            ...
                                            <div class="card my-3">
                                                <div class="card-header">
                                                    <label class="form-label">
                                                        ...
                                                        <i class="bi bi-question-circle" data-bs-toggle="tooltip"
                                                            title="Maximum size allowed 1MB"></i>
                                                        <span class="help-text">Only use this option if you have a
                                                            trailer video added</span>
                                                    </label>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mt-3 media-container">
                                                            <img src="{{ asset($course->trailer_cover) }}"
                                                                width="150" />
                                                            <button type="button"
                                                                class="btn btn-sm delete-media-btn btn btn-outline-danger"
